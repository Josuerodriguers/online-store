...
export const paymentMethods = [
  { id: 1, dataTest: 'ticket-payment', name: 'Boleto' },
  { id: 2, dataTest: 'visa-payment', name: 'Visa' },
  { id: 3, dataTest: 'master-payment', name: 'MasterCard' },
  { id: 4, dataTest: 'elo-payment', name: 'Elo' },
];
